...
window.onload=function(){ 
    ...
    let arr=[];
    let bodytop;
    let section = document.querySelectorAll(".cen-1box>.cen-1");
//  console.log(section)
...
//	let document.querySelect(".cen-1 cen-2")
//	console.log(arr);
	window.onscroll=function(){
		bodytop=document.body.scrollTop || document.documentElement.scrollTop;
		//显示隐藏楼层
		let leftlist=document.querySelector('.rcdh');
		if(bodytop>=1200){
	...
	//跳转楼层
	let list = document.querySelectorAll(".lctz>li");
//	console.log(list)
